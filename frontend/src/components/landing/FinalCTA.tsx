    ...
    <section className="py-14 md:py-16 bg-blue-700">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        <h2 className="text-3xl md:text-4xl font-extrabold text-white mb-4">
          Explore the CampusTwin Operations Dashboard
        </h2>
        <p className="text-base md:text-lg text-blue-100 mb-7 max-w-2xl mx-auto">
          View real-time classroom, attendance, transportation, and campus service information from one connected platform.
        </p>

...
const roles = [
  ...
  },
  {
    ...
    label: 'Teacher',
    icon: BookOpen,
    desc: 'Tools for running classes, attendance, and classroom usage.',
    actions: ['Start or end class', 'Generate QR attendance', 'View student lists', 'Reserve classrooms'],
  ...
  },
  {
    ...
    label: 'Security',
    icon: Shield,
    desc: 'Operational controls for campus access, alerts, and parking updates.',
    actions: ['Verify visitors', 'Update parking status', 'Send emergency alerts', 'Review entry history'],
  ...
  },
  {
    ...
    label: 'Admin',
    icon: Settings,
    desc: 'A control view for users, reports, campus modules, and backups.',
    actions: ['Manage users', 'Review reports', 'Track complaints', 'Run backup'],

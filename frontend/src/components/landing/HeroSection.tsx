      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex flex-col lg:flex-row items-center gap-16">
          ...
          <div className="flex-1 text-center lg:text-left z-10">
            <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-blue-100/50 border border-blue-200 text-blue-800 text-sm font-semibold mb-8 backdrop-blur-sm">
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center lg:justify-start gap-4">
              <Link to="/demo" className="inline-flex items-center justify-center px-8 py-4 text-base font-bold text-white bg-blue-600 rounded-full hover:bg-blue-700 hover:shadow-xl hover:shadow-blue-600/30 hover:-translate-y-1 transition-all duration-300 w-full sm:w-auto group">
                Explore Live Campus
                <ArrowRight className="ml-2 w-5 h-5 group-hover:translate-x-1 transition-transform" />
              </Link>
              <a href="#how-it-works" className="inline-flex items-center justify-center px-8 py-4 text-base font-bold text-slate-700 bg-white border border-slate-200 rounded-full hover:bg-slate-50 hover:border-slate-300 transition-all duration-300 w-full sm:w-auto">
                View How It Works
              </a>
            </div>
          </div>
          ...
          <div className="flex-1 relative w-full max-w-2xl lg:max-w-none perspective-1000 z-10">
            <div className="relative transform lg:rotate-y-[-10deg] lg:rotate-x-[5deg] transition-transform duration-500 hover:rotate-0">
              ...
              <div className="bg-white rounded-3xl shadow-2xl border border-slate-100 overflow-hidden relative">
                ...
                <div className="p-2 relative h-[400px] bg-[url('https://grainy-gradients.vercel.app/noise.svg')] opacity-90">
              ...
              <div className="absolute -left-6 top-16 bg-white p-4 rounded-2xl shadow-xl border border-slate-100 w-64 animate-float">
              ...
              <div className="absolute -right-8 top-1/2 bg-white p-4 rounded-2xl shadow-xl border border-slate-100 w-60 animate-float-delay-1">
                <div className="flex items-center gap-3 mb-3">
              ...
              <div className="absolute left-10 -bottom-6 bg-white p-4 rounded-2xl shadow-xl border border-slate-100 w-64 animate-float-delay-2">
